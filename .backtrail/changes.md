...
| [CHANGE-033](./changes/change-00033-add-node-entrypoint-to-base-api-template.md)               | 2026-04-26 | Proposed  | -                                                                                    | Add Node entrypoint to base API template              |
...
| [CHANGE-035](./changes/change-00035-add-either-validation-container.md)                        | 2026-04-26 | Proposed  | [ADR-023](./adrs/adr-00023-use-either-for-typed-result-values.md)                    | Add Either container                                  |
| [CHANGE-036](./changes/change-00036-use-either-in-validation.md)                               | 2026-04-26 | Proposed  | [ADR-023](./adrs/adr-00023-use-either-for-typed-result-values.md)                    | Use Either in validation                              |
