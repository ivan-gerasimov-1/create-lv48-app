...
| ----------- | ---------- | ------------------------------------------------------------- |
| Implemented | 2026-04-14 | [ADR-001_IMPLEMENTATION-PLAN.md](./ADR-001_IMPLEMENTATION-PLAN.md) |
...
- [ADR-002: Colocate test files with tested code](../adr-002/ADR-002.md) depends on this decision's Vitest test discovery contract.
