...
- `.logtrail/adl.md`
- `.logtrail/changes.md`
- `.logtrail/adrs/adr-NNNNN-title-slug.md`
- `.logtrail/changes/change-NNNNN-title-slug.md`
...
- Existing accepted ADRs that mention `docs/adl.md`, `docs/changes.md`, `docs/adrs/`, or `docs/changes/` need follow-up references or a newer decision if the path rule must be fully replaced.
