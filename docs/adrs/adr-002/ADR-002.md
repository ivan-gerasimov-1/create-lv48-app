...
| ----------- | ---------- | ------------------------------------------------------------- |
| Implemented | 2026-04-14 | [ADR-002_IMPLEMENTATION-PLAN.md](./ADR-002_IMPLEMENTATION-PLAN.md) |
...
- [ADR-001: Use Vitest for tests](../adr-001/ADR-001.md) establishes the Vitest runner and discovery behavior this decision updates.
