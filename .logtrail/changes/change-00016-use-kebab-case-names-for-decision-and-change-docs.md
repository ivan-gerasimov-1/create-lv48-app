...
2. Rename every ADR record to `doadrs/adr-NNNNN-title-slug.md` and every CHANGE record to `dochanges/change-NNNNN-title-slug.md`.
...
```bash
rg -n "docs/ADL\\.md|docs/CHANGES\\.md|doadrs/ADR-|dochanges/CHANGE-|ADR-NNN|CHANGE-NNN" .
npm run test
```
