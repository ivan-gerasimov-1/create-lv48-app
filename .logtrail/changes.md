...
- Store each change in `.logtrail/changes/change-NNNNN-title-slug.md`.
...
| [CHANGE-025](./changes/change-00025-use-default-dist-cli-build-output.md)                     | 2026-04-25 | Proposed  | [ADR-020](./adrs/adr-00020-use-default-dist-cli-build-output.md)                     | Use default dist CLI build output                     |
