...
- Store each decision in `.logtrail/adrs/adr-NNNNN-title-slug.md`.
- Store implementation plans and delivery records in `.logtrail/changes/change-NNNNN-title-slug.md`.
