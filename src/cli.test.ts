...
import { removePaths } from "#/utils/fs";
...
describe("cli", () => {
  // TODO: Fix CLI tests to work with current runCli signature
  // Tests disabled due to dependency injection pattern not supported by current implementation
  it.todo("runs the full CLI flow and prints a final summary", async () => {
